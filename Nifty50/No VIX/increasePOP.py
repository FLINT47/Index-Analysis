...
# plt.plot(df_increase_70['Year'], df_increase_70['Increase for 70%'], label='Increase for 70%', marker='o')
# plt.plot(df_increase_80['Year'], df_increase_80['Increase for 80%'], label='Increase for 80%', marker='o')
# plt.plot(df_increase_90['Year'], df_increase_90['Increase for 90%'], label='Increase for 90%', marker='o')
# plt.plot(df_increase_98['Year'], df_increase_98['Increase for 98%'], label='Increase for 98%', marker='o', color='purple')
...
# Initialize dictionary to hold the required increases for 98% probability


# # Calculate the required increases for 98% probability for each year
# for year in yearly_stats['year']:
...
# # Updating the plot to include the 98% probability
# plt.figure(figsize=(12, 6))
# plt.plot(df_increase_70['Year'], df_increase_70['Increase for 70%'], label='Increase for 70%', marker='o')
# plt.plot(df_increase_80['Year'], df_increase_80['Increase for 80%'], label='Increase for 80%', marker='o')
# plt.plot(df_increase_90['Year'], df_increase_90['Increase for 90%'], label='Increase for 90%', marker='o')
...
# # Save the updated probability increase plot as an image file
# updated_probability_increase_plot_filename = '/mnt/data/updated_probability_increase_plot.png'
# plt.savefig(updated_probability_increase_plot_filename)
# plt.close()

# updated_probability_increase_plot_filename, 